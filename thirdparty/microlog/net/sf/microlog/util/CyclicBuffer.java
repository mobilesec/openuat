...
public class CyclicBuffer {
	...
	/**
	 * The current length of the buffer, i.e. how many <code>Object</code>s
	 ...
	 * the buffer.
	 * 
	 * @return the oldest <code>Object</code> in the buffer. If no more
	 *         objects are in the buffer, <code>null</code> is returned.
	 */
