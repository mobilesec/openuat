...
import net.sf.microlog.appender.SyslogAppender;
import net.sf.microlog.format.PatternFormatter;

/**
 * An example midlet that shows how to use the <code>SyslogAppender</code>,
 * which uses a <code>DatagramConnection</code>. This requires MIDP 2.0 or
 * greater.
 * 
 * @author Johan Karlsson
 * @since 0.6
 */
public class SysLogMidlet extends MIDlet implements CommandListener{
