...
/**
 * An example midlet that shows how to use the <code>BluetoothSerialAppender</code>.
 * This requires an implementation of JSR-82 on the target platform.
 * 
 * @author Johan Karlsson
 * @since 0.9
 */
public class BluetoothSerialLogMidlet extends MIDlet implements CommandListener{
	...
	public BluetoothSerialLogMidlet() {
		super();
		BluetoothSerialAppender appender = new BluetoothSerialAppender();
