 ...
 * with SSL, i.e. a <code>SecureSocketConnection</code> is used. This requires
 * MIDP 2.0 or greater.
 * 
 * @author Johan Karlsson
 * @since 0.6
 */
public class SecureSocketLogMidlet extends MIDlet {

	private final static Logger log = Logger.getLogger();

	public SecureSocketLogMidlet() {
		super();
		SocketAppender socketAppender = new SocketAppender();
		socketAppender.setLinger(20);
		socketAppender
				.setProtocol(SocketAppender.SECURE_SOCKET_PROTOCOL_STRING);
		socketAppender.setPort(443);
