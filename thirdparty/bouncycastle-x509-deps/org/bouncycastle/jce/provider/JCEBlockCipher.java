...
/*    static public class RC6
        ...
        extends JCEBlockCipher
    {
        public AESCBC()
        {
            super(new CBCBlockCipher(new AESLightEngine()), 128);
        }
    }
        ...
        extends JCEBlockCipher
    {
        public AESCFB()
        {
            super(new CFBBlockCipher(new AESLightEngine(), 128), 128);
        }
    }
        ...
        extends JCEBlockCipher
    {
        public AESOFB()
        {
            super(new OFBBlockCipher(new AESLightEngine(), 128), 128);
        }
    }
...
/*    static public class PBEWithSHAAndIDEA
        ...
        extends JCEBlockCipher
    {
        ...
        {
            super(new CBCBlockCipher(new AESLightEngine()));
        }
    }
}
