 ...
 *
 */
public class AudioOpenUATmidlet extends OpenUATmidlet implements CommandListener,
BluetoothPeerManager.PeerEventsListener, AuthenticationProgressHandler{
	...
	public AudioOpenUATmidlet() {
		super();
	}

	protected void initGui() {
		
		mainForm = new Form("OpenUAT - Audio channel");
