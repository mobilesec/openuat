...
/** This interface represents a sink for vector sample values, and only defines
 * three methods: to add new sample vectord, to react to a segment becoming
...
public interface VectorSamplesSink {
	 ...
	 * 
	 * @param sample The new sample vector to add.
