package org.openuat.channel.http;
 ...
 *	commThread.start();
 *
 *  Additional, the calling object must also be run as thread!
...
public class CommPlain implements ifComm {
	 ...
	 */
	public CommPlain(String _serverLocation){
	...
	private synchronized void get() {
		...
		try {
			retString = new String(requestUsingGET(URL1).toCharArray());
		} catch (Exception e) {
